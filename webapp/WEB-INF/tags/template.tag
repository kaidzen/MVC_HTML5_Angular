...
<head>
    ...
    <spring:url value="/recource/js/bootstrap.min.js" var="js"/>
    <script src="${js}"/>
</head>
<body>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Tutorial<b class="carret"></b></a>
                    <ul class="dropdown-menu">
                        <c:url value="/file.html" var="file"/>
                        <li>
                            <a href="${file}">Пример загрузки файла PDF или Excel</a>
                        </li>
                        <li>
